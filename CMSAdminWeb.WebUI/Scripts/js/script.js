	...
	var handleDataTables = function () {
		...
		$('#datatable2').dataTable({
                ...
                oTableTools: {
                    ...
                    sSwfPath: "Scripts/js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
                }
			});
	...
	var handleChat = function (elem) {
		var append = function() {
			...
			var msg = '';
				...
				msg +=	'<img class="media-object" alt="Generic placeholder image" src="Content/img/chat/headshot2.jpg">';
				msg +=  '</a>';
